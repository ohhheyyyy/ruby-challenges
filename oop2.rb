...
class Tree < Plants
	...
	def about_tree_fir
		return "Another plant I grow is a #{@name} tree; it can grow to be #{@height} tall."
	end	
end
...
my_tree_fir = Tree.new
my_tree_fir.set_name = 'fir'
my_tree_fir.set_height = '20ft'
puts my_garden_tomato.about_garden
puts my_tree_fir.about_tree_fir